...
export default function PersonalTodo(props) {
  ...
  const getTodos = async () => {
    try {
      ...
      const q = query(collection(db, "todos"), where("createdBy.uid", "==", user.uid), where('status', '==', 'personal'));
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col my-4">
            <h1 className={`text-center text-${props.mode === "light" ? "dark" : 'light'}`}>Personal Todos</h1>
